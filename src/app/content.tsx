            ...
            return (
              <AnimatePresence key={index} mode="wait">
                <motion.li
                  ...
                  className="bg-slate-900 text-center hover:bg-slate-800 hover:z-[98] shadow-cs-section px-10 py-5 rounded-3xl basis-5/12 flex-1 relative mb-5 mx-1 xl:mx-3 md:max-lg:mx-3 duration-200 flex flex-col justify-center max-w-[100%]"
                >
                  <img
                    src={image}
                    alt=""
